...
export function SessionShareActions({
  ...
  async function handleCopy() {
    try {
      ...
      setError("Failed to copy link. Try again.");
    }
  }
  ...
  async function handleShareCard() {
    ...
    try {
      ...
      if ((e as Error).name !== "AbortError") {
        ...
        setError(
          `Failed to generate share card. ${(e as Error).message || "Try again."}`
        );
      }
    } finally {
    ...
    <div className="quick-actions compact">
      ...
      >
        ...
        <div className="qa-title">
          {downloading ? "Generating…" : "Story Card"}
        </div>
        <div className="qa-sub">Cover + leaderboard for IG/WA</div>
      </button>
      <button
        type="button"
        className="qa-btn"
      ...
      >
        ...
        <div className="qa-title">WhatsApp</div>
        <div className="qa-sub">Send text + link</div>
      </button>
      <Link
      ...
      >
        ...
        <div className="qa-title">Leaderboard</div>
      ...
      >
        ...
        <div className="qa-title">{copied ? "Copied!" : "Copy Link"}</div>
        <div className="qa-sub">Direct view link</div>
      </button>
    </div>
    </>
  );
