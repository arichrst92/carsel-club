    ...
    <>
      <main className="app-content subscreen with-footer">
        <div className="auth-step">
          ...
          <h2 className="auth-step-title">Masukkan Nomor WhatsApp</h2>
          <p className="auth-step-sub">
            Kami akan kirim 6-digit kode OTP via WhatsApp untuk verifikasi nomor
            kamu.
          </p>
          ...
          >
            ...
            <p className="form-help">
              Nomor harus aktif WhatsApp untuk terima OTP.
            </p>
      ...
      <div className="sticky-footer">
        ...
        >
          <span>{isPending ? "Mengirim OTP..." : "Kirim OTP"}</span>
          {!isPending && (
            <svg
              width="20"
              height="20"
